...
/***/ (function(module, exports, __webpack_require__) {
	...
	angular.module('angularjs-dropdown-multiselect', ['ui.bootstrap']).directive('dmDropdownStaticInclude', ["$compile", function ($compile) {
		'ngInject';
	...
	}]).directive('ngDropdownMultiselect', _angularjsDropdownMultiselect2.default); // import angularUI from 'angular-ui-bootstrap';
